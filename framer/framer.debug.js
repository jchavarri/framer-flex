...
/***/ function(module, exports, __webpack_require__) {
	...
	Framer.Layer = (__webpack_require__(/*! ./Layer */ 12)).Layer;
	
	Framer.BackgroundLayer = (__webpack_require__(/*! ./BackgroundLayer */ 38)).BackgroundLayer;
	
	Framer.VideoLayer = (__webpack_require__(/*! ./VideoLayer */ 39)).VideoLayer;
	
	Framer.Events = (__webpack_require__(/*! ./Events */ 14)).Events;
	
	Framer.Gestures = (__webpack_require__(/*! ./Gestures */ 32)).Gestures;
	
	Framer.Animation = (__webpack_require__(/*! ./Animation */ 16)).Animation;
	
	Framer.AnimationGroup = (__webpack_require__(/*! ./AnimationGroup */ 40)).AnimationGroup;
	
	Framer.Screen = (__webpack_require__(/*! ./Screen */ 5)).Screen;
	
	Framer.Canvas = (__webpack_require__(/*! ./Canvas */ 41)).Canvas;
	
	Framer.print = (__webpack_require__(/*! ./Print */ 42)).print;
	
	Framer.ScrollComponent = (__webpack_require__(/*! ./Components/ScrollComponent */ 45)).ScrollComponent;
	
	Framer.PageComponent = (__webpack_require__(/*! ./Components/PageComponent */ 46)).PageComponent;
	
	Framer.SliderComponent = (__webpack_require__(/*! ./Components/SliderComponent */ 47)).SliderComponent;
	
	Framer.DeviceComponent = (__webpack_require__(/*! ./Components/DeviceComponent */ 48)).DeviceComponent;
	...
	Framer.Context = (__webpack_require__(/*! ./Context */ 43)).Context;
	
	Framer.Config = (__webpack_require__(/*! ./Config */ 13)).Config;
	...
	Framer.LayerStyle = (__webpack_require__(/*! ./LayerStyle */ 23)).LayerStyle;
	
	Framer.AnimationLoop = (__webpack_require__(/*! ./AnimationLoop */ 49)).AnimationLoop;
	
	Framer.LinearAnimator = (__webpack_require__(/*! ./Animators/LinearAnimator */ 17)).LinearAnimator;
	
	Framer.BezierCurveAnimator = (__webpack_require__(/*! ./Animators/BezierCurveAnimator */ 19)).BezierCurveAnimator;
	
	Framer.SpringDHOAnimator = (__webpack_require__(/*! ./Animators/SpringDHOAnimator */ 22)).SpringDHOAnimator;
	
	Framer.SpringRK4Animator = (__webpack_require__(/*! ./Animators/SpringRK4Animator */ 20)).SpringRK4Animator;
	
	Framer.LayerDraggable = (__webpack_require__(/*! ./LayerDraggable */ 25)).LayerDraggable;
	
	Framer.Importer = (__webpack_require__(/*! ./Importer */ 50)).Importer;
	
	Framer.Debug = (__webpack_require__(/*! ./Debug */ 51)).Debug;
	
	Framer.Extras = __webpack_require__(/*! ./Extras/Extras */ 52);
	
	Framer.Version = __webpack_require__(/*! ../build/Version */ 55);
	...
	Defaults = (__webpack_require__(/*! ./Defaults */ 15)).Defaults;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Utils.convertPointToContext = function(point, layer, rootContext, includeLayer) {
	  ...
	  for (m = 0, len = ancestors.length; m < len; m++) {
	...
	Utils.convertPointFromContext = function(point, layer, rootContext, includeLayer) {
	  ...
	  ancestors = layer.ancestors(rootContext);
	  if (ancestors.length) {
	    point = ancestors.pop().matrix3d.inverse().point(point);
	  }
	  ancestors.reverse();
	  if (includeLayer) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	libhusl = __webpack_require__(/*! husl */ 10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  if ((typeof requirejs !== "undefined" && requirejs !== null) && ("function" !== "undefined" && __webpack_require__(/*! !webpack amd define */ 11) !== null)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Animation, BaseClass, Color, Config, Defaults, EventEmitter, Events, GestureManager, LayerDraggable, LayerLayout, LayerStates, LayerStyle, Matrix, NoCacheDateKey, Utils, _, layerProperty, layerValueTypeError,
	  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty,
	  indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
	...
	Config = __webpack_require__(/*! ./Config */ 13).Config;
	
	Events = __webpack_require__(/*! ./Events */ 14).Events;
	...
	Animation = __webpack_require__(/*! ./Animation */ 16).Animation;
	
	LayerStyle = __webpack_require__(/*! ./LayerStyle */ 23).LayerStyle;
	
	LayerStates = __webpack_require__(/*! ./LayerStates */ 24).LayerStates;
	
	LayerDraggable = __webpack_require__(/*! ./LayerDraggable */ 25).LayerDraggable;
	
	LayerLayout = __webpack_require__(/*! ./LayerLayout */ 33).LayerLayout;
	
	Matrix = __webpack_require__(/*! ./Matrix */ 35).Matrix;
	
	GestureManager = __webpack_require__(/*! ./GestureManager */ 36).GestureManager;
	...
	exports.Layer = (function(superClass) {
	  ...
	  function Layer(options) {
	    ...
	    this._perspectiveMatrix = bind(this._perspectiveMatrix, this);
	    this._perspectiveProjectionMatrix = bind(this._perspectiveProjectionMatrix, this);
	    this._properties = {};
	    this._style = {};
	    this._children = [];
	  ...
	  ref = LayerLayout.layoutProps;
	  fn = function(layoutProp) {
	  ...
	  Layer.prototype._perspectiveProjectionMatrix = function(element) {
	    var m, p;
	  ...
	  Layer.prototype._perspectiveMatrix = function(element) {
	    var ox, oy, ppm;
	    ox = element.perspectiveOriginX * element.width;
	    oy = element.perspectiveOriginY * element.height;
	    ppm = this._perspectiveProjectionMatrix(element);
	  ...
	  Layer.define("matrix3d", {
	    get: function() {
	      ...
	      ppm = this._perspectiveMatrix(parent);
	  ...
	  Layer.prototype.canvasScaleX = function() {
	    var context, j, len1, parent, ref1, scale;
	    scale = this.scale * this.scaleX;
	    ref1 = this.ancestors(context = true);
	    for (j = 0, len1 = ref1.length; j < len1; j++) {
	      parent = ref1[j];
	  ...
	  Layer.prototype.screenScaleX = function() {
	    var context, j, len1, parent, ref1, scale;
	    scale = this.scale * this.scaleX;
	    ref1 = this.ancestors(context = false);
	    for (j = 0, len1 = ref1.length; j < len1; j++) {
	      parent = ref1[j];
	      scale = scale * parent.scale * parent.scaleX;
	    }
	  ...
	  Layer.prototype.screenScaledFrame = function() {
	    var context, factorX, factorY, frame, j, layerScaledFrame, layers, len1, parent;
	    frame = {
	      x: 0,
	      y: 0,
	  ...
	  Layer.define("html", {
	    get: function() {
	      var ref1;
	      return ((ref1 = this._elementHTML) != null ? ref1.innerHTML : void 0) || "";
	    },
	    set: function(value) {
	  ...
	  Layer.prototype.destroy = function() {
	    ...
	    if ((ref1 = this._element.parentNode) != null) {
	      ref1.removeChild(this._element);
	    }
	    this.removeAllListeners();
	    this.gestures.removeAllListeners();
	    this._context.removeLayer(this);
	    return this._context.emit("layer:destroy", this);
	  };
	
	  Layer.prototype.copy = function() {
	    var child, copiedChild, j, layer, len1, ref1;
	  ...
	  Layer.prototype.animatingProperties = function() {
	    var animation, j, len1, len2, n, properties, propertyName, ref1, ref2;
	    properties = {};
	    ref1 = this.animations();
	    for (j = 0, len1 = ref1.length; j < len1; j++) {
	      animation = ref1[j];
	      ref2 = animation.animatingProperties();
	  ...
	  Layer.prototype.animateStop = function() {
	    ...
	    return (ref1 = this._draggable) != null ? ref1.animateStop() : void 0;
	  };
	  ...
	  Layer.define("layout", {
	    get: function() {
	      if (this._layout == null) {
	        this._layout = new LayerLayout(this);
	      }
	      return this._layout;
	    }
	  });
	  ...
	  Layer.prototype._parentDraggableLayer = function() {
	    var j, layer, len1, ref1, ref2;
	    ref1 = this.ancestors().concat(this);
	    for (j = 0, len1 = ref1.length; j < len1; j++) {
	      layer = ref1[j];
	      if ((ref2 = layer._draggable) != null ? ref2.enabled : void 0) {
	        return layer;
	      }
	    }
	    return null;
	  ...
	  Layer.define("gestures", {
	    get: function() {
	      if (this._gestures == null) {
	        this._gestures = new GestureManager(this);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	LinearAnimator = __webpack_require__(/*! ./Animators/LinearAnimator */ 17).LinearAnimator;
	
	BezierCurveAnimator = __webpack_require__(/*! ./Animators/BezierCurveAnimator */ 19).BezierCurveAnimator;
	
	SpringRK4Animator = __webpack_require__(/*! ./Animators/SpringRK4Animator */ 20).SpringRK4Animator;
	
	SpringDHOAnimator = __webpack_require__(/*! ./Animators/SpringDHOAnimator */ 22).SpringDHOAnimator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Animator = __webpack_require__(/*! ../Animator */ 18).Animator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Integrator = __webpack_require__(/*! ../Integrator */ 21).Integrator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Simulation = __webpack_require__(/*! ./Simulation */ 26).Simulation;
	
	Defaults = __webpack_require__(/*! ./Defaults */ 15).Defaults;
	
	EventBuffer = __webpack_require__(/*! ./EventBuffer */ 31).EventBuffer;
	
	Gestures = __webpack_require__(/*! ./Gestures */ 32).Gestures;
	...
	exports.LayerDraggable = (function(superClass) {
	  ...
	  LayerDraggable.define("pinchable", LayerDraggable.simpleProperty("pinchable", false));
	
	  LayerDraggable.define("rotatable", LayerDraggable.simpleProperty("rotatable", false));
	  ...
	  function LayerDraggable(layer) {
	    ...
	    this._rotate = bind(this._rotate, this);
	  ...
	  LayerDraggable.prototype._touchStart = function(event) {
	    ...
	    if (this.pinchable) {
	      ...
	      this.layer.gestures.on(Gestures.Pinch, this._pinch);
	    }
	    if (this.rotatable) {
	      this._rotationStart = null;
	      this._rotationOffset = null;
	      this.layer.gestures.on(Gestures.Rotate, this._rotate);
	    }
	  ...
	  LayerDraggable.prototype._pinch = function(event) {
	    if (!this.pinchable) {
	      return;
	    }
	    ...
	    this.layer.scale = event.scale * this._scaleStart;
	    return this.emit(Events.Pinch, event);
	  };
	
	  LayerDraggable.prototype._rotate = function(event) {
	    if (!this.rotatable) {
	      return;
	    }
	    ...
	    this.layer.rotation = event.rotation - this._rotationOffset + this._rotationStart;
	    return this.emit(Events.Rotate, event);
	  };
	  ...
	  LayerDraggable.prototype.onPinch = function() {
	    return this.on(Events.Pinch, cb);
	  };
	
	  LayerDraggable.prototype.onRotate = function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	SpringSimulator = __webpack_require__(/*! ./Simulators/SpringSimulator */ 27).SpringSimulator;
	
	FrictionSimulator = __webpack_require__(/*! ./Simulators/FrictionSimulator */ 29).FrictionSimulator;
	
	MomentumBounceSimulator = __webpack_require__(/*! ./Simulators/MomentumBounceSimulator */ 30).MomentumBounceSimulator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Simulator = __webpack_require__(/*! ../Simulator */ 28).Simulator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	SpringSimulator = __webpack_require__(/*! ./SpringSimulator */ 27).SpringSimulator;
	
	FrictionSimulator = __webpack_require__(/*! ./FrictionSimulator */ 29).FrictionSimulator;
...
/* 33 */
/*!***********************************!*\
  !*** ./framer/LayerLayout.coffee ***!
  \***********************************/
/***/ function(module, exports, __webpack_require__) {

	var EventEmitter, _, computeLayout,
	  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	
	computeLayout = __webpack_require__(/*! css-layout */ 34);
	
	EventEmitter = __webpack_require__(/*! ./EventEmitter */ 7).EventEmitter;
	
	_ = __webpack_require__(/*! ./Underscore */ 1)._;
	
	exports.LayerLayout = (function(superClass) {
	  extend(LayerLayout, superClass);
	
	  LayerLayout.layoutProps = ["fixedWidth", "fixedHeight", "minWidth", "minHeight", "maxWidth", "maxHeight", "left", "right", "top", "bottom", "margin", "marginLeft", "marginRight", "marginTop", "marginBottom", "padding", "paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth", "flexDirection", "justifyContent", "alignItems", "alignSelf", "flex", "flexWrap", "position"];
	
	  LayerLayout.prototype.curve = void 0;
	  ...
	  function LayerLayout(layer) {
	    ...
	    for (property in LayerLayout.layoutProps) {
	  ...
	  LayerLayout.prototype.updateProperty = function(property, value) {
	    if (property) {
	  ...
	  LayerLayout.prototype._updateTree = function(layersChanged) {
	  ...
	  LayerLayout.prototype._setNeedsUpdate = function() {
	    var newTree, rootLayer, rootLayoutNode;
	    ...
	    return rootLayer.layout._updateLayer(newTree.children[0]);
	  };
	
	  LayerLayout.prototype._updateLayer = function(computedTree) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Hammer = __webpack_require__(/*! hammerjs */ 37);
	...
	exports.GestureManager = (function(superClass) {
	  ...
	  GestureManager.prototype.removeListener = function(eventName, listener) {
	    ...
	    return this._manager.off(eventName, listener._actual);
	  };
	  ...
	  GestureManager.prototype._getRecognizer = function(eventFamily) {
	    var ref;
	    if ((ref = this._manager) != null ? ref.get(eventFamily) : void 0) {
	      return this._manager.get(eventFamily);
	    }
	    switch (eventFamily) {
	      case Gestures.Pan:
	  ...
	  GestureManager.prototype._getDependentRecognizersForEventFamily = function(eventFamily) {
	    ...
	    switch (eventFamily) {
	      ...
	      case Gestures.Pinch:
	        ...
	        if (rotate = this._manager.get(Gestures.Pinch)) {
	          existingRecognizers.push(rotate);
	        }
	        break;
	      case Gestures.DoubleTap:
	  ...
	  GestureManager.prototype.onPan = function(cb) {
	    return this.on(Gestures.Pan, cb);
	  };
	
	  GestureManager.prototype.onPanStart = function(cb) {
	    return this.on(Gestures.PanStart, cb);
	  };
	
	  GestureManager.prototype.onPanMove = function(cb) {
	    return this.on(Gestures.PanMove, cb);
	  };
	
	  GestureManager.prototype.onPanEnd = function(cb) {
	    return this.on(Gestures.PanEnd, cb);
	  };
	
	  GestureManager.prototype.onPanCancel = function(cb) {
	    return this.on(Gestures.PanCancel, cb);
	  };
	
	  GestureManager.prototype.onPanLeft = function(cb) {
	    return this.on(Gestures.PanLeft, cb);
	  };
	
	  GestureManager.prototype.onPanRight = function(cb) {
	    return this.on(Gestures.PanRight, cb);
	  };
	
	  GestureManager.prototype.onPanUp = function(cb) {
	    return this.on(Gestures.PanUp, cb);
	  };
	
	  GestureManager.prototype.onPanDown = function(cb) {
	    return this.on(Gestures.PanDown, cb);
	  };
	
	  GestureManager.prototype.onPinch = function(cb) {
	    return this.on(Gestures.Pinch, cb);
	  };
	
	  GestureManager.prototype.onPinchStart = function(cb) {
	    return this.on(Gestures.PinchStart, cb);
	  };
	
	  GestureManager.prototype.onPinchMove = function(cb) {
	    return this.on(Gestures.PinchMove, cb);
	  };
	
	  GestureManager.prototype.onPinchEnd = function(cb) {
	    return this.on(Gestures.PinchEnd, cb);
	  };
	
	  GestureManager.prototype.onPinchCancel = function(cb) {
	    return this.on(Gestures.PinchCancel, cb);
	  };
	
	  GestureManager.prototype.onPinchIn = function(cb) {
	    return this.on(Gestures.PinchIn, cb);
	  };
	
	  GestureManager.prototype.onPinchOut = function(cb) {
	    return this.on(Gestures.PinchOut, cb);
	  };
	
	  GestureManager.prototype.onPress = function(cb) {
	    return this.on(Gestures.Press, cb);
	  };
	
	  GestureManager.prototype.onPressUp = function(cb) {
	    return this.on(Gestures.PressUp, cb);
	  };
	
	  GestureManager.prototype.onRotate = function(cb) {
	    return this.on(Gestures.Rotate, cb);
	  };
	
	  GestureManager.prototype.onRotateStart = function(cb) {
	    return this.on(Gestures.RotateStart, cb);
	  };
	
	  GestureManager.prototype.onRotateMove = function(cb) {
	    return this.on(Gestures.RotateMove, cb);
	  };
	
	  GestureManager.prototype.onRotateEnd = function(cb) {
	    return this.on(Gestures.RotateEnd, cb);
	  };
	
	  GestureManager.prototype.onRotateCancel = function(cb) {
	    return this.on(Gestures.RotateCancel, cb);
	  };
	
	  GestureManager.prototype.onSwipe = function(cb) {
	    return this.on(Gestures.Swipe, cb);
	  };
	
	  GestureManager.prototype.onSwipeLeft = function(cb) {
	    return this.on(Gestures.SwipeLeft, cb);
	  };
	
	  GestureManager.prototype.onSwipeRight = function(cb) {
	    return this.on(Gestures.SwipeRight, cb);
	  };
	
	  GestureManager.prototype.onSwipeUp = function(cb) {
	    return this.on(Gestures.SwipeUp, cb);
	  };
	
	  GestureManager.prototype.onSwipeDown = function(cb) {
	    return this.on(Gestures.SwipeDown, cb);
	  };
	
	  GestureManager.prototype.onTap = function(cb) {
	    return this.on(Gestures.Tap, cb);
	  };
	
	  GestureManager.prototype.onSingleTap = function(cb) {
	    return this.on(Gestures.SingleTap, cb);
	  };
	
	  GestureManager.prototype.onDoubleTap = function(cb) {
	    return this.on(Gestures.DoubleTap, cb);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Layer = __webpack_require__(/*! ./Layer */ 12).Layer;
	...
	exports.BackgroundLayer = (function(superClass) {
	  ...
	  function BackgroundLayer(options) {
	    ...
	    this.backgroundLayout = bind(this.backgroundLayout, this);
	    ...
	    this._context.domEventManager.wrap(window).addEventListener("resize", this.backgroundLayout);
	  }
	
	  BackgroundLayer.prototype.backgroundLayout = function() {
	    if (this.parent) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Context = __webpack_require__(/*! ./Context */ 43).Context;
...
/***/ function(module, exports, __webpack_require__) {
	...
	DOMEventManager = __webpack_require__(/*! ./DOMEventManager */ 44).DOMEventManager;
...
/***/ function(module, exports, __webpack_require__) {
	...
	GestureManagerElement = __webpack_require__(/*! ./GestureManager */ 36).GestureManagerElement;
...
/***/ function(module, exports, __webpack_require__) {
	...
	ScrollComponent = __webpack_require__(/*! ./ScrollComponent */ 45).ScrollComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.MobileScrollFix = __webpack_require__(/*! ./MobileScrollFix */ 53);
	
	exports.OmitNew = __webpack_require__(/*! ./OmitNew */ 54);
